...
class FormatManager(threading.Thread):
	...
	def userEvent(self, formats, title):
		raw_data = {'UID':self.__data[0], 'EventGroup':self.__data[1], 'Code':self.__data[2], 'DatailCode':self.__data[3], 'EventTime':self.__data[4].strftime('%Y-%m-%d %H:%M:%S'),
		...
		return self.__delimiter.join(utility.formatting(formats, title, 0, raw_data))

	def alarm_System(self, formats, title):
		raw_data = {'UID':self.__data[0], 'Code':self.__data[1], 'AlarmType':self.__data[2], 'AlarmTime':self.__data[3].strftime('%Y-%m-%d %H:%M:%S'), 'TargetIP':self.__data[4], 'TargetName':self.__data[5],
		'SystemType':self.__data[6], 'Description':self.__data[7], 'Recognized':self.__data[8]}

		return self.__delimiter.join(utility.formatting(formats, title, 1, raw_data))

	def alarm_IP(self, formats, title):
		raw_data = {'UID':self.__data[0], 'Code':self.__data[1], 'AlarmType':self.__data[2], 'AlarmTime':self.__data[3].strftime('%Y-%m-%d %H:%M:%S'), 'MonitoringMode':self.__data[4],
		...
		return self.__delimiter.join(utility.formatting(formats, title, 2, raw_data))

	def alarm_PC(self, formats, title):
		raw_data = {'UID':self.__data[0], 'AlarmTime':self.__data[1].strftime('%Y-%m-%d %H:%M:%S'), 'AlarmType':self.__data[2], 'Code':self.__data[3], 'DetailCode':self.__data[4],
		...
		return self.__delimiter.join(utility.formatting(formats, title, 3, raw_data))
	...
	def ua_UserEvent(self, formats, title):
		raw_data = {'EventID':self.__data[0], 'Code':self.__data[1], 'EventTime':self.__data[2].strftime('%Y-%m-%d %H:%M:%S'), 'UserID':self.__data[3], 'UserName':self.__data[4], 'Jumin':self.__data[5],
		...
		return self.__delimiter.join(utility.formatting(formats, title, 6, raw_data))
